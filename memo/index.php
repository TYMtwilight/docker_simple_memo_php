  ...
  <div class="h-100">
      ...
      <div class="col-3 h-100 m-0 p-0 border-left border-right border-gray">
        ...
        <div class="left-memo-list list-group-flush p-0">
          ...
          <a href="./action/select.php?id=<?php echo $memo['id']; ?>"
            ...
            <p class="mb-1">
              <?php if(mb_strlen($memo['content']) <= 100) {
                  echo $memo['content'];
              } else {
    ...
    <div class="col-9 h-100">
      ...
      <form>
        ...
        <div id="memo-menu">
          <button type="submit" class="btn btn-danger" formaction="./action/delete.php"><i
              class="fas fa-trash-alt"></i></button>
          <button type="submit" class="btn btn-success" formaction="./action/update.php"><i
